...
image::images/5-vscode-existing-folders.png[title="Student Playbooks",width=400]
...
Type iis_advanced and hit enter.  Then click that folder so it is selected.

Hover over the 'student#' section again and click the 'New File' button.
...
image::images/5-vscode-create-folders.png[title="Empty site.yml",width=1000]
...
Ensure your *iis_advanced folder* is highlighted and then hover over the 'student#' section and click the 'New Folder' button
...
image::images/5-survey.png[title="Survey Form",width=500]
...
Click the rocketship icon image:images/at_launch_icon.png[Add,35,25] for the *IIS Advanced* Job Template.
