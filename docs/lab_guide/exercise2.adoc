...
Next to each host is a checkbox.  Check the box next to each host you want to run an Ad-Hoc Command on.  You will then see the image:images/2-adhoc-run-command-button.png[Run Command,20,20] button become enabled.  Click it now.
...
image::images/2-adhoc-run-win_ping-log-1.png[title="Win_Ping Log Details",width=1000]
...
image::images/2-adhoc-run-win_ping-log-output.png[title="Win_Ping Log Details",width=1000]
