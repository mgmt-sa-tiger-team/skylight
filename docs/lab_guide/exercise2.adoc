...
To start, we will need to goto our Inventory.  So click *INVENTORY* on the left panel, and then click on the name of our Inventory *Ansible Workshop Inventory*.
...
image::2-win_ping.png[title="Run Win_Ping",width=1000]
...
image::images/2-win_ping_success.png[title="Win_Ping Log Details",width=1000]
