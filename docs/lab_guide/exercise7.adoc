...
=== Step 1:
Within Visual Studio Code, we will now create a new directory in your git repo and create a new playbook file.
...
image::images/7-win_update-playbook.png[title="site.yml part 2"]
